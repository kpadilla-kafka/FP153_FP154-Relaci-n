/* =========================================================
   ...
   FP154 para la Región Central Occidente y establecer las
   relaciones con el usuario delegado existente en FP153.

   Usuario incluido:
   - ID 44: Andrey José Delgado Vásquez

   Observaciones:
   - Se excluyen dos registros de la región debido a que
     los usuarios no poseen cargo asignado y/o licencia
     activa según validación realizada con el cliente.

   Alcance:
   - 5 Áreas Rectoras de Salud.
   - 3 roles por ARS.
   - 15 tareas para el usuario.

   Resultado esperado:
   Visualización de 15 ramas asociadas al usuario dentro
   de la FP153.
...
BEGIN TRY
    ...
    DECLARE @IdUsuario153 INT = 44; -- Andrey Delgado Vásquez
