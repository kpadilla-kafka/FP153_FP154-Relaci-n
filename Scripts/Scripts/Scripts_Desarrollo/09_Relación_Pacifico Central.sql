...
FP154 (Ramas de Usuarios) para la Región Pacífico Central
y establecer las relaciones con los usuarios delegados
existentes en la FP153.

Usuarios incluidos:

* ID 38: Alfredo Viales Wahrmann
* ID 39: Rolando Salazar Moreno
* ID 40: Dayanna Calderón Abarca
...
* Visualización de 27 ramas asociadas para cada usuario
...
BEGIN TRY
    ...
    DECLARE @IdUsuario153 INT = 38; -- Alfredo Viales Wahrmann
    -- Para Rolando: DECLARE @IdUsuario153 INT = 39; -- Rolando Salazar Moreno
    -- Para Dayanna: DECLARE @IdUsuario153 INT = 40; -- Dayanna Calderón Abasrca
