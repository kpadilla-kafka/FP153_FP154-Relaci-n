/* =========================================================
   ...
   FP154 para la Región Huetar Norte y establecer las
   relaciones con los usuarios delegados existentes en FP153.

   Usuarios incluidos:
   - ID 35: Roger Miranda Barrantes
   - ID 36: Jenory Fernández Peraza
   - ID 37: José María Cordero Herrera

   Alcance:
   - 6 Áreas Rectoras de Salud.
   - 3 roles por ARS.
   - 18 tareas por usuario.
   - 54 tareas totales para la Región Huetar Norte.

   Resultado esperado:
   Visualización de 18 ramas asociadas por usuario en FP153.
   ========================================================= */
...
BEGIN TRY
    ...
    DECLARE @IdUsuario153 INT = 35; -- Roger Miranda Barrantes
    -- Para Jenory:     DECLARE @IdUsuario153 INT = 36; -- Jenory Fernández Peraza
    -- Para José María: DECLARE @IdUsuario153 INT = 37; -- José María Cordero Herrera
