...
FP154 (Ramas de Usuarios) para la Región Huetar Caribe
y establecer las relaciones con los usuarios delegados
existentes en la FP153.

Usuarios incluidos:

* ID 33: Leidy Serrano Álvarez
* ID 34: Carlos Smith Alterno
...
* Visualización de 18 ramas asociadas para cada usuario
...
BEGIN TRY
    ...
    DECLARE @IdUsuario153 INT = 33; -- Leidy Serrano Álvarez
    -- Para Carlos: DECLARE @IdUsuario153 INT = 34; -- Carlos Smith Alterno
