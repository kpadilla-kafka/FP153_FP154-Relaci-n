...
FP154 (Ramas de Usuarios) para la Región Central Norte
y establecer las relaciones con los usuarios delegados
existentes en la FP153.

Usuarios incluidos:

* ID 28: Dayana Melissa Fajardo Aguirre
* ID 29: Hugo Alberto Chavarría Oviedo
* ID 30: Wilder Martínez Álvares
...
* Visualización de 36 ramas asociadas para cada usuario
  dentro de la FP153 (Usuarios Delegados).

Usuarios por script:

DECLARE @IdUsuario153 INT = 29; -- Hugo Alberto Chavarría Oviedo
DECLARE @IdUsuario153 INT = 30; -- Wilder Martínez Álvares
...
BEGIN TRY
    ...
    DECLARE @IdUsuario153 INT = 28; -- Dayana Melissa Fajardo Aguirre
