/* =========================================================
   ...
   Central Sur y establecer las relaciones con los
   usuarios delegados registrados en la FP153.

   Usuarios incluidos:
   - ID 17: Bibiana Marchena Morales
   - ID 18: Danny Astorga Aguilar
...
BEGIN TRY
    ...
    DECLARE @IdUsuario153 INT = 17; -- Bibiana Marchena Morales
    -- Para Danny: DECLARE @IdUsuario153 INT = 18; -- Danny Astorga Aguilar
    ...
    ('7.6.1.4.1.','Región Central Sur - ARS Carmen-Merced-Uruca','Funcionario revisor PSF'),
    ('7.6.1.4.2.','Región Central Sur - ARS Carmen-Merced-Uruca','Funcionario firmante PSF'),
    ('7.6.1.4.3.','Región Central Sur - ARS Carmen-Merced-Uruca','Funcionario reportería PSF'),
    ...
    IF (SELECT COUNT(*) FROM @RamasCentralSur) <> 57
        THROW 50001, 'La cantidad de ramas Central Sur no es 57.', 1;
    ...
    IF (SELECT COUNT(*) FROM @NuevasRamas) <> 57
        THROW 50002, 'No se crearon 57 tareas FP154 para el usuario.', 1;
    ...
    IF (
        ...
        THROW 50003, 'No se crearon 57 relaciones para el usuario.', 1;
