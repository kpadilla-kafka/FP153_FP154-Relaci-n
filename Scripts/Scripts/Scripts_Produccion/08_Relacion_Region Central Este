...
Central Este y establecer las relaciones con los
usuarios delegados registrados en la FP153.

Usuarios incluidos:

* ID 11: Ana Gabriela Monestel Brenes
* ID 12: Mariela Díaz Ríos
* ID 13: Nuria Isela Villalta Solano
...
BEGIN TRY
    ...
    DECLARE @IdUsuario153 INT = 11; -- Ana Gabriela Monestel Brenes
    -- Para Mariela: DECLARE @IdUsuario153 INT = 12; -- Mariela Díaz Ríos
    -- Para Nuria:   DECLARE @IdUsuario153 INT = 13; -- Nuria Isela Villalta Solano
