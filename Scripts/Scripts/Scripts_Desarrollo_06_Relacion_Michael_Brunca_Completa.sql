/* =========================================================
   ...
   USUARIO: Michael Mora Fernandez
   REGIÓN: BRUNCA
   TRÁMITE: 20
   FECHA: 2026-06-19
   ...
   Usuario FP153:
   ID 24 - Michael Mora Fernandez

   Resultado esperado:
   - FP154 debe incrementar en 18 registros para Región Brunca.
   - FP153 de Michael debe mostrar 18 ramas asociadas.
   - Las relaciones deben quedar registradas con RelationId = 24.
...
DECLARE @IdUsuario153 INT = 24; -- Michael Mora Fernandez
